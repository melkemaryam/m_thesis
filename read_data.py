...
class Read_data():
	...
	def get_articles(self):
		...
		if (args["preprocess"] == 'no'):
			...
			df_article = pd.read_csv("drive/My Drive/info/articles_with_labels.csv", sep='\t', lineterminator='\n')
	...
	def get_titles(self):
		...
		if (args["preprocess"] == 'no'):
			...
			df_article = pd.read_csv("/content/drive/MyDrive/info/titles_with_labels.csv", sep='\t', lineterminator='\n')
			data = self.adjust_data(df_article)
			...
			df_title = pd.read_csv("/content/drive/MyDrive/info/titles_with_labels.csv", sep='\t', lineterminator='\n')
