# from: https://github.com/Microkiller/Dic/blob/master/MOD_Load_MasterDictionary_v2022.py
"""
...
if __name__ == '__main__':
    ...
    md = (r'/content/drive/MyDrive/info/Loughran-McDonald_MasterDictionary_1993-2021.csv')
