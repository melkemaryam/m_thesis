...
class Args():
	...
	def parse_arguments(self):
		...
		ap.add_argument("-m", "--model", default='tf', choices=['log', 'svm', 'nb', 'basic', 'cnn', 'lstm', 'bilstm'], required=False, help="choose model")
		ap.add_argument("-v", "--vector", default='tfidf', choices=['tfidf', 'count', 'w2v'], required=False, help="choose vectoriser")
		ap.add_argument("-op", "--optimiser", default='boost', choices=['boost', 'bayesian', 'hyperband', 'random'], required=False, help="optimisation method for classifier")
